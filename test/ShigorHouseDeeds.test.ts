import { ShigorHouseDeeds } from "../typechain-types";
...
let nft: ShigorHouseDeeds;

const setupTest = async () => {
    const factory = await ethers.getContractFactory("ShigorHouseDeeds");
    nft = await factory.deploy();
};

describe("ShigorHouseDeeds", function () {
    before(async () => {
